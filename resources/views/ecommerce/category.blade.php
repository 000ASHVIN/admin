        ...
        <div class="row product-btn d-flex justify-content-between">
                ...
                <div class="select-this d-flex">
                    ...
                    <div class="select-itms">
                        <select class="select" name="select" id="select1" onchange="window.location.href='/category/'+this.value+'/product'">
                            <option value="">select</option>
                            @foreach($categories as $category)
                            <option value="{{$category->id}}" @isset($selectedCategory)
                                @if($selectedCategory->id == $category->id)
                                 selected='selected'
                                 @endif
                            @endisset>{{$category->product_type}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-product mb-60">
                            <div class="product-img">
                                <img class="w-100 h-100" src="/storage/{{$product->product_image}}" alt="">
                            ...
                            <div class="product-caption">
                                ...
                                <h4><a href="/ecommerce/product/{{$product->id}}">{{$product->product_name}}</a></h4>
                                <div class="price">
                                    <ul>
