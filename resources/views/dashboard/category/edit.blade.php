            ...
            <div class="col-lg-8 pl-5">
                <form method="POST" action="/category/{{$category->id}}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="product-type" class="au-input au-input--full form-control @error('product-type') is-invalid @enderror" type="text" name="product-type" value="{{ $category->product_type }}" placeholder="product-type">
                    ...
                    <div class="form-group">
                        ...
                        <input id="description" class="au-input au-input--full form-control @error('description') is-invalid @enderror" type="text" name="description" value="{{ $category->description }}" placeholder="description">
                        ...
                        <div class="rs-select2--dark rs-select2--sm rs-select2--border d-block">
                            <select id="is-active" class="js-select2 au-select-dark form-control @error('is-active') is-invalid @enderror" name="is-active">
                                ...
                                <option value="1" @if($category->is_active == 1)
                                    ...
                                    @endif 
                                >Yes</option>
                                <option value="0" @if($category->is_active == 0)
                                        selected="selected"
                                    @endif >No</option>
                            </select>
